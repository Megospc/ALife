...
9. Семя симуляции.
10. Управление записью. «Сохранить» - сохраняет запись. «Остановить» - останавливает запись.
